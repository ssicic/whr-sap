...
```{r wealth} 
wealth <- read_excel("C:/Users/Sara/Documents/My Fax/SAP/whr-sap/files/credit_suisse_global_wealth_databook_2021_table_31.xlsx")
...
## Case study 1: Je li razina sreće veća u 2020. ili 2021. godini?

Ovo pitanje ćemo provjeravati uparenim t-testom. Upareni t-test koristimo kada želimo vidjeti je li srednja vrijednost razlike parova podataka jednaka nuli ili ne.
...
boxplot(whr2020$`Ladder score`, whr2021$`Ladder score`, names = c("Ladder scores in 2020.", "Ladder scores in 2021."))
```

Vidimo da su srednje vrijednosti rezultata za obje godine otprilike jednake.

Kada smo pogledali podatke, uočili smo da su rezultati za Sjevernu Makedoniju u dokumentu za 2020. godinu navedeni pod imenom "Makedonija". Odlučili smo joj u tom dokumentu promijeniti naziv u "Sjeverna Makedonija", kako bi on bio isti kakav je i u dokumentu za 2021. godinu, kako bi se podaci mogli dobro spojiti.
...
Mogli bismo reći da su podaci približno normalno distribuirani, no da su ipak više zbijeni oko sredine.
...
Kao i histogram, qq-plot nam upućuje na normalnost podataka. Jedini podaci koji se ne ravnaju savršeno po normalnoj distribuciji su oni rubni.
...
## Case study 2: Možemo li temeljem drugih dostupnih variabli predvidjeti sreću neke nacije? 
...
## Case study 3: Postoje li razlike u iskazanoj sreći medu različitim regijama?
...
ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Central and Eastern Europe'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Central and Eastern Europe']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Central and Eastern Europe']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Central and Eastern Europe'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Commonwealth of Independent States'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Commonwealth of Independent States']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Commonwealth of Independent States']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Commonwealth of Independent States'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='East Asia'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='East Asia']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='East Asia']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='East Asia'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Latin America and Caribbean'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Latin America and Caribbean']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Latin America and Caribbean']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Latin America and Caribbean'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Middle East and North Africa'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Middle East and North Africa']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Middle East and North Africa']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Middle East and North Africa'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='North America and ANZ'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='North America and ANZ']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='North America and ANZ']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='North America and ANZ'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='South Asia'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='South Asia']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='South Asia']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='South Asia'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Southeast Asia'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Southeast Asia']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Southeast Asia']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Southeast Asia'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Sub-Saharan Africa'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Sub-Saharan Africa']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Sub-Saharan Africa']))
hist(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Sub-Saharan Africa'])

ks.test(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Western Europe'], "pnorm", mean(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Western Europe']),sd(whr2021$`Ladder score`[whr2021$`Regional indicator`=='Western Europe']))
