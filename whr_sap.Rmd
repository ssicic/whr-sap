...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Central and Eastern Europe'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Commonwealth of Independent States'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='East Asia'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Latin America and Caribbean'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Middle East and North Africa'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='South Asia'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Southeast Asia'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Sub-Saharan Africa'])
...
lillie.test(whr2021_data$`Ladder score`[whr2021_data$`Regional indicator`=='Western Europe'])
